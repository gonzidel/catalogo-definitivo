...
const RESOURCE_LINKS = [
  ...
  {
    href: "/quienes-somos",
    label: "Quiénes somos — empresa familiar mayorista en Chaco",
  },
];
...
export default function QuienesSomosPage() {
  return (
    <main className="howto about-fyl" aria-label="Quiénes somos">
      ...
      <section className="howto-section" aria-label="Ubicación">
        ...
        <article className="info-card about-fyl__location">
          ...
          >
            ...
            <img
              src={`${BASE_PATH}/assets/maps/mapa-fyl.jpg`}
      ...
      <section className="howto-section about-fyl__block" aria-label="Guías y recursos">
        <div className="howto-section__head">
