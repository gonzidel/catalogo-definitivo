-- 227_meta_feed_phase2_commercial_sources.sql
-- Fase 2 Meta feed: filtro2/3, detalles, supplier, oferta_activa para labels + google en Edge.
...
COMMENT ON FUNCTION public.get_meta_feed() IS
  'Meta Catalog feed Fase 2: +filtro2/3, detalles, supplier, oferta para labels/google en Edge.';
