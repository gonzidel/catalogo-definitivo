-- 335_ROLLBACK_rpc_checkout_cart_effective_price.sql
-- Restaura rpc_checkout_cart() a canonical 331 (pre-autoridad de precio).
--
-- 331_rpc_checkout_cart_sellable_gate.sql
