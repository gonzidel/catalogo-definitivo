      ...
      >
        <div className="info-banner-top__inner">
          <div className="info-banner-top__iconWrap" aria-hidden="true">
            <svg
              className="info-banner-top__icon info-banner-top__wa-icon"
              viewBox="0 0 48 48"
              aria-hidden="true"
            >
              <defs>
                <linearGradient id="info-banner-wa-grad" x1="24" y1="4" x2="24" y2="44" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#D4955E" />
                  <stop offset="100%" stopColor="#B8723F" />
                </linearGradient>
              </defs>
              <circle cx="24" cy="24" r="21" fill="url(#info-banner-wa-grad)" />
              <path
                fill="#FFF8F0"
          ...
          <div className="info-banner-top__content">
            ...
            <p className="info-banner-top__line">
              Consultá por WhatsApp y coordinamos tu pedido
            </p>
