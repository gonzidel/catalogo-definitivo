-- 193_catalog_public_available_view.sql
-- Vista pública del catálogo basada en stock REAL disponible.
-- No reemplaza catalog_public_view para evitar romper consumidores existentes.
