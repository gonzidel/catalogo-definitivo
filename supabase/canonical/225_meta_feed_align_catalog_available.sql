-- 225_meta_feed_align_catalog_available.sql
-- Fase 1: alinear get_meta_feed() con catalog_public_available_view (stock real por talle).
-- Una fila por variant_sizes.sku vendible; sin filas out of stock; links catalogo?sku=
