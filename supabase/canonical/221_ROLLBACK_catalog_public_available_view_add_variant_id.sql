-- 221_ROLLBACK_catalog_public_available_view_add_variant_id.sql
-- Revierte 221 (quita variant_id de la vista y del snapshot).
--
-- ATENCIÓN: DROP VIEW breve. Ejecutar refresh snapshot tras rollback si el grid usa snapshot.
-- Alternativa: restaurar 193 desde git commit anterior a 221 y ejecutar solo grants + snapshot DROP.
...
-- Definición pre-221 (sin variant_id). Mantener alineado con 193 si se revierte también en repo.
