...
-- Corrige rpc_checkout_cart para que al hacer "Hacer pedido" en el dashboard se descuente
-- el stock en variant_size_warehouse_stock (por talle). La versión en 123 solo descontaba
-- en variant_warehouse_stock, por eso el stock por talle no bajaba.
...
BEGIN
  ...
  LOOP
    ...
    -- Descontar por talle (variant_size_warehouse_stock) si hay size y hay stock
