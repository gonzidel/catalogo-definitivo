// Generated by scripts/fetch-cities.js
// Data source: https://raw.githubusercontent.com/wecodeio/ciudades-argentinas/master/ciudades-argentinas.json
// Generated at: 2025-12-30T12:22:45.991Z

const PROVINCE_CITIES_RAW: Record<string, string[]> = {
  "Buenos Aires": [
    "11 De Septiembre",
    "12 De Octubre",
    "16 De Julio",
  ...
  "Chaco": [
    ...
    "El Sauzalito",
    "Enrique Urien",
    "Estacion Estacion General Obligado",
    "Fontana",
    "Fortin Las Chuñas",
    "Fortin Lavalle",
    "Fuerte Esperanza",
  ...
  "Cordoba": [
    ...
    "Santa Rosa De Rio Primero (Est. Villa Santa Rosa)",
    "Santiago Temple",
    "Sarmiento",
    ...
    "Villa Carlos Paz",
    "Villa Cerro Azul",
    "Villa Ciudad De America (Loteo Diego De Rojas)",
    "Villa Ciudad Parque Los Reartes (1A. Seccion)",
    "Villa Ciudad Parque Los Reartes (3A. Seccion)",
  ...
  "Corrientes": [
    ...
    "Paso De La Patria",
    "Paso De Los Libres",
    "Pedro R. Fernandez (Est. Manuel F. Mantilla)",
    "Perugorria",
    "Ramada Paso",
    "Riachuelo",
    "Saladas",
  ...
  "La Pampa": [
    ...
    "General Pico",
    "General San Martin (Est. Villa Alba)",
    "Gobernador Duval",
    "Guatrache",
    "Hucal",
    "Ingeniero Foster",
  ...
  "Salta": [
    ...
    "El Bordo",
    "El Carril",
    "El Galpon (Est. Foguista J. F. Juarez)",
    "El Jardin",
    "El Naranjo",
    ...
    "Gaona",
    "General Ballivian",
    "General GÜEMES (Est. GÜEMES)",
    "General Mosconi (Est. Vespucio)",
    "General Pizarro",
    "Guachipas",
    "Hickman",
    "Hipolito Yrigoyen (Est. Tabacal)",
    "Iruya",
    "Isla De Cañas",
    "Joaquin V. Gonzalez",
    "La Caldera",
    ...
    "San Carlos",
    "San Felipe",
    "San Jose De Metan (Est. Metan)",
    "San Jose De Orquera",
    "San Marcos",
    "San Ramon De La Nueva Oran (Est. Oran)",
    "Santa Maria",
    "Santa Rosa",
  ...
  "Santa Fe": [
    "Aaron Castellanos (Est. Castellanos)",
    "Acebal",
    "Aguara Grande",
    "Albarellos",
    "Alcorta",
    ...
    "Golondrina",
    "Granadero Baigorria",
    "Gregoria Perez De Denis  (Est. El Nochero)",
    "Grutly",
    "Guadalupe Norte",
    "GÖDEKEN",
    "Helvecia",
    ...
    "Villa Guillermina",
    "Villa Josefina",
    "Villa La Rivera (Comuna Oliveros)",
    "Villa La Rivera (Comuna Pueblo Andino)",
...
/** Deduplica nombres repetidos en el JSON fuente (misma localidad listada 2+ veces). */
function uniqueCities(list: string[]): string[] {
...
export const PROVINCE_CITIES_DATA: Record<string, string[]> = Object.fromEntries(
  Object.entries(PROVINCE_CITIES_RAW).map(([province, cities]) => [
    province,
    uniqueCities(cities),
  ])
);
