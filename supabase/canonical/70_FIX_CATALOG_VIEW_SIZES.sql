-- 70_FIX_CATALOG_VIEW_SIZES.sql
-- Actualizar catalog_public_view para cargar talles desde variant_sizes en lugar de product_variants.size

-- Dropear la vista existente
drop view if exists public.catalog_public_view;

-- Recrear la vista con talles desde variant_sizes
