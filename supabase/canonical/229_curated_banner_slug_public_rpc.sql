-- 229_curated_banner_slug_public_rpc.sql
--
-- Permite abrir #/banner/{slug} aunque el banner esté deshabilitado en home.
-- Solo resuelve por slug (no lista banners); SECURITY DEFINER evita ampliar RLS anon.
